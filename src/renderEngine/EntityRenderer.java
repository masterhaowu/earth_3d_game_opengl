...
public class EntityRenderer {
	...
	private void prepareInstance(Entity entity) {
		Matrix4f transformationMatrix = Maths.createTransformationMatrixWithYOffset(entity.getPosition(), entity.getRotX(),
				entity.getRotY(), entity.getRotYOffset(), entity.getScale());
		shader.loadTransformationMatrix(transformationMatrix);
		shader.loadOffset(entity.getTextureXOffset(), entity.getTextureYOffset());
		shader.loadHighlighted(entity.isHighlighted());
		if (entity.isEnableShaderAnimation()) {
			Vector3f centerPos = Vector3f.sub(entity.getModel().getRawModel().getMax(),
